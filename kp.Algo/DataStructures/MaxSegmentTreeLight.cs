...
{
	/// <summary>
	/// Segemnt tree for [0..n) and maximum operation
	/// Supports cell modifications
	/// </summary>
	public class MaxSegmentTreeLight<T> where T : IComparable<T>
	{
		private readonly T[] _tree;
		private readonly int _shift;
		private readonly int _n;

		public MaxSegmentTreeLight( int n, T initialCellValue, T minusInfinity )
			: this( GetArr( n, initialCellValue ), minusInfinity )
		{

		}

		public MaxSegmentTreeLight( T[] initialArray, T minusInfinity )
		{
		...
		/// <summary>
		/// Returns maximum value on a segment [l, r]
		/// The complexity is O(log(r-l))
		/// </summary>
		public T GetMax( int l, int r )
		{
